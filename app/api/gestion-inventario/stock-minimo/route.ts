...
/**
 * GET /api/gestion-inventario/stock-minimo
 * Devuelve todos los productos con stock por debajo del mínimo (staff).
 */
  ...
  try {
    const result = await pool.query(`
      SELECT
        ...
        bp.stock_minimo,
        (bp.cantidad_disponible - bp.stock_minimo) AS diferencia,
      ...
      if (existe.rowCount === 0) {
        ...
        await client.query(
          `UPDATE bodega_producto
           SET stock_minimo = $1, ultima_actualizacion = NOW()
