                  ...
                  <tr key={p.id_producto} style={{ ...s.tr, opacity: p.estado_producto ? 1 : 0.5 }}>
                    ...
                    <td style={{ ...s.td, textAlign: "center" }}>
                      <div style={{ display: "flex", gap: "0.4rem", justifyContent: "center" }}>
                        <button type="button" onClick={() => abrirEditar(p)} style={s.btnEdit} title="Editar">✏️</button>
                        <button type="button" onClick={() => setConfirmId(p.id_producto)} style={s.btnDel} title="Eliminar">🗑️</button>
                      </div>
                    </td>
                  </tr>
                ))
                    ...
                    <tr key={p.id_producto} style={s.tr}>
                      ...
                      <td style={{ ...s.td, textAlign: "center" }}>
                        {editingThis ? (
                          ...
                          <button type="button" onClick={() => iniciarEditarPrecio(p)} style={s.btnEdit}>✏️ Editar</button>
                        )}
                      </td>
                    </tr>
                  );
...
const s: Record<string, CSSProperties> = {
  ...
  btnPrimary: { background: "var(--accent)", color: "#0d1117", border: "none", borderRadius: "var(--radius)", padding: "0.6rem 1.2rem", fontFamily: "var(--font-head)", fontSize: "0.88rem", fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" } as CSSProperties,
